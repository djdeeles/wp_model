<div class="yanmenu">
  <h2 class="widgettitle">Gold İlanlar</h2>
  <div>
    <?php $kategori = get_option('gold_kat'); ?>
    ...
    <div class="sag-kutu2">
      <div class="sag-ortala2">
        ...
        <div class="vip"><a href="<?php the_permalink() ?>"><img src="<?php bloginfo('template_url'); ?>/resim/gold_side.png" class="ballon" onmouseover="tooltip.show('<?php echo get_post_meta($post->ID, "sehir", true); ?>');" onmouseout="tooltip.hide();" border="0" width="90" height="120" alt=""/></a></div>
      </div>
    </div>
    <?php endforeach; ?>
  </div>
