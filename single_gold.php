<div class="aciklama4">
	<div class="bilgibaslik">Gold İlanlar</div>
	<div>
		<?php 
		$args = array( 
			'posts_per_page'   => 9, 
		...
		<div class="sag-kutu">
			<div class="sag-ortala">
				...
				<div class="vip"><a href="<?php the_permalink() ?>"><img src="<?php bloginfo('template_url'); ?>/resim/gold_single.png" class="ballon" onmouseover="tooltip.show('<?php if (get_post_meta($post->ID, "semt", true) != null) { echo get_post_meta($post->ID, "sehir", true) ." - ". get_post_meta($post->ID, "semt", true); } else { echo get_post_meta($post->ID, "sehir", true); } ?>');" onmouseout="tooltip.hide();" border="0" width="105" height="145" alt=""/></a></div>
			</div>
		</div>
	<?php endforeach; ?>
</div>
